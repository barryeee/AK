...
void create(){
    ...
    SetDefaultRead("\n %^CYAN%^Welcome to the Pit of Despair! We hope your stay here will be short! And it probably will be,since guests in this cell have already been sentenced to death.  \n No one has ever escaped from here, but we do hope you try!  There is a reward of 50 gold pieces for anyone who escapes this prison to freedom.
	%^RED%^Have fun trying!! %^RESET%^");
    SetMass(20);
